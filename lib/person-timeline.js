...
export const EVENT_KINDS = {
  ...
  /* 12 Sep 2026, with migration 0034. A meeting is a `logged` event — somebody
   * on our team recorded it — never `theirs` and never `system`. Its activity
   * row is BACKDATED to when the meeting happened, so it sorts into the
   * timeline where it belongs rather than on the day it was typed in. */
  meeting: { icon: "◇", head: "Meeting", by: "logged" },
