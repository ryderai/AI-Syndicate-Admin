 ...
 *    it.
 *
 * 3. NULL IS NOT ZERO. A rep who sent no emails has `emailed: 0`. A rep whose
...
export const REP_METRICS = [
  ...
  },
  {
    ...
    period: PERIOD_NOW, better: "high", unit: "count",
    what: "Leads they hold that are still live.",
    read: ({ s }) => num(s?.open),
    sub: null,
  },
  {
  ...
  },
  {
    ...
    what: "Claims they hold that have run out or gone quiet, right now. Fewer is better.",
  ...
  },
  {
    ...
    what: "Their leads that closed the other way, over every contact loaded. Fewer is better.",
    read: ({ s }) => num(s?.lost),
    sub: null,
  },
];
