...
const previewStore = {
  ...
  tasks: [
    { id: "t1", client_id: "c1", name: "Ship llms.txt + agents.md", status: "done", category: "Technical", priority: "high", phase: "Month 1", assigned_to: "preview-user", due_date: daysAgo(10).slice(0, 10), latest_report: "All three AI files live and verified 200.", created_at: daysAgo(12) },
    { id: "t2", client_id: "c1", name: "Schema on all listing pages", status: "in_progress", category: "Technical", priority: "high", phase: "Month 1", assigned_to: "preview-user", due_date: daysAgo(-3).slice(0, 10), latest_report: "12 of 26 pages done.", created_at: daysAgo(6) },
    ...
    { id: "t4", client_id: "c2", name: "Unblock 3 AI crawlers at firewall", status: "blocked", category: "Access", priority: "high", phase: "Ongoing", assigned_to: "preview-user", due_date: null, latest_report: "Blocked until firewall login exists.", created_at: daysAgo(20) },
